...
public class CreateAddressRequestDto {
    ...
    @NotBlank(message = "VALIDATION.ADDRESS.ADDRESS_LINE1.BLANK")
    @Size(
            max = 200,
    ...
    @NotBlank(message = "VALIDATION.ADDRESS.DISTRICT.BLANK")
    @Size(
            max = 100,
    ...
    @NotBlank(message = "VALIDATION.ADDRESS.PINCODE.BLANK")
    @Pattern(
            regexp = "^[1-9][0-9]{5}$",
    ...
    @NotNull(message = "VALIDATION.ADDRESS.LOCATION_TYPE.NULL")
    @Schema(
    ...
    @NotNull(message = "VALIDATION.ADDRESS.TYPE.NULL")
    @Schema(
